...
public class Main {
    public static void main(String[] args) {
        ...
        while (option <= 7) {
            if (option == 1) {
                firstString = addContent(firstString);
                System.out.println("Your new string is: " + firstString);
    ...
    public static void afterPrefix2(String firstString) {
        ...
        int startingPoint = index + prefix.length();

        for (int i = startingPoint; i < firstString.length(); i++) {
    ...
    public static void betweenPrefixSuffix(String firstString) {
        ...
        int startingPoint = index1 + prefix.length();
        int index2 = firstString.indexOf(suffix);
        for (int i = startingPoint; i <= index2 - 1; i++) {
            char suffixChar = firstString.charAt(i);
            System.out.print(suffixChar);
        }
    }
